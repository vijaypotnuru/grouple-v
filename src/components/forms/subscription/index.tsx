	...
	return (
		<>
			<GlassModal
				trigger={
					<span>
						<Card className="flex aspect-video cursor-pointer items-center justify-center gap-x-2 rounded-xl border-themeGray border-dashed bg-themeBlack text-themeGray">
							<Tag />
							<p>Add a price</p>
						</Card>
					</span>
