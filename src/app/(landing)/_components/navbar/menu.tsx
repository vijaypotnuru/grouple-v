...
const Menu = ({ orientation }: MenuProps) => {
	...
	switch (orientation) {
		case "desktop":
			return (
				<Card className="backdrop--blur__safari hidden rounded-xl border-themeGray bg-themeGray bg-opacity-60 bg-clip-padding p-1 backdrop-blur-2xl backdrop-filter lg:flex">
