		...
		<div className={cn("flex gap-x-3", optimistic ? "opacity-50" : "")}>
			<div className="flex flex-col gap-y-1">
				...
				<Separator
					...
					className="h-0 flex-1 self-center bg-themeGray"
				/>
			</div>
			<div className="mt-2 flex w-full flex-col items-start gap-y-2 pb-5">
				...
				<div className="flex items-center gap-x-5">
					...
					{!noReply && (
						<span
							...
							className="flex cursor-pointer items-center gap-x-1 text-themeTextGray text-xs"
						>
							<Chat />
							Reply
						</span>
				...
				{replyCount && replyCount > 0 ? (
					<>
						...
						<span
							...
							className="cursor-pointer rounded-lg p-2 text-sm hover:bg-themeGray"
						>
							Load more replies
						</span>
					</>
